    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                dir = MApplication.appContext.getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = MApplication.appContext.getCacheDir() + File.separator + "log" + File.separator;
            }
        }
