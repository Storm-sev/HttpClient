...
import static com.cheng315.chengnfc.MApplication.appContext;
...
public class NetWorkUtils {
    ...
    public static boolean isOpenDataEnabled() {
        ...
        try {
            TelephonyManager manager =
                    (TelephonyManager) MApplication.appContext.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnable() {
        ...
        WifiManager wifiManager
                = (WifiManager) MApplication.appContext.getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ...
        ConnectivityManager cm =
                (ConnectivityManager) MApplication.appContext.getSystemService(Context.CONNECTIVITY_SERVICE);
